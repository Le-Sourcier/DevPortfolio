...
const Home = () => {
  ...
  const safeProjects = Array.isArray(apiProjects) ? apiProjects : [];
  ...
  const mappedPosts = safePosts.map((p) => ({
    id: p.id,
  ...
  const featuredProjects = mappedProjects.slice(0, 3);
